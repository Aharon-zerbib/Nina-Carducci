  ...
  (t.fn.mauGallery = function (a) {
    ...
    (t.fn.mauGallery.listeners = function (a) {
      t(".gallery-item").on("click", function () {
        ...
        t(".gallery-item").on("keydown", function (e) {
          "Enter" === e.key &&
            a.lightBox &&
            "IMG" === t(this).prop("tagName") &&
            t.fn.mauGallery.methods.openLightBox(t(this), a.lightboxId);
        }),
        t(".gallery").on("keydown", ".nav-link", function (a) {
          "Enter" === a.key && t.fn.mauGallery.methods.filterByTag.call(this);
        }),
        t(".gallery").on("keydown", ".mg-prev", function (e) {
          "Enter" === e.key && t.fn.mauGallery.methods.prevImage(a.lightboxId);
        }),
        t(".gallery").on("keydown", ".mg-next", function (e) {
          "Enter" === e.key && t.fn.mauGallery.methods.prevImage(a.lightboxId);
        });
    }),
      ...
      showItemTags(a, e, l) {
        ...
        t.each(l, function (t, a) {
          i += `<li class="nav-item active">
                <span tabindex="0" class="nav-link"  data-images-toggle="${a}">${a}</span></li>`;
        });
